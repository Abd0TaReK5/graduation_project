            ...
            <Flex style={{ marginTop: '40px', width: '70%' }}>
                ...
                >
                        ...
                        {cartItems.items.map((item) => (
                            <>
                                ...
                                <Text style={{ fontSize: '16px', fontWeight: '400', textAlign: 'right' }}>
                                    EGP {Number(item.price && exchangeRate ? item.price * exchangeRate: 0) * Number(item.quantity)}
                                </Text>
                            </>
                        ))}
                    </Flex>
                    ...
                    >
                        ...
                        >
                            EGP {cartItems.totalPrice && exchangeRate ? cartItems.totalPrice * exchangeRate + 100 : 0}
                        </Text>
                    </Flex>
                    <Row
                        style={{

...
export const CartPage = () => {
    ...
    fetch('http://localhost:5000/api/currency/products')
        ...
        .catch(err => console.error('Fetch exchange rate error:', err));
    }, []);
    ...
    const convertedTotalPrice = exchangeRate
    ? cart.totalPrice * exchangeRate
    : 0;
    ...
    const Price = (props: { price: number; quantity: number }) => {
        ...
        return <Text style={{ fontSize: '16px' }}> EGP {price * quantity}</Text>;
    };
    ...
    const dataSource = cart.items.map((item) => {
        return {
            ...
            price: <Price price={item && exchangeRate ? item.price * exchangeRate : 0}
                ...
                >
                    ...
                    >
                        ...
                        <Text style={{ fontSize: '18px', fontWeight: '500',color: token.colorPrimary }}>
                                         {Math.round(convertedTotalPrice)}
                                    </Text>
                                    ) : (
                    ...
                    >
                        ...
                        >
                            EGP {Math.round(convertedTotalPrice + shippingFee)}
                        </Text>
                    </Row>

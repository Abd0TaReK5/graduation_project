...
export const SignUpPage = () => {
    ...
    const onSubmit = (data: IUserSignUpFormData & { securityCode?: string }) => {
    const { confirmPassword, securityCode, ...dataToSubmit } = data;
        ...
        <Row gutter={16} style={{ height: '100vh' }}>
            ...
            >
                <div style={{ width: '90%', padding: '30px 0 30px 0' }}>
                    ...
                    >
                        <Link to="/">
                            <img src={assets.loginLogo} alt="loginLogo" width={300} style={{ marginBottom: '20px' }} />
                        </Link>
                            ...
                            rules={[
                                { required: true, message: 'Please enter the security code!' },
                                {
                                    validator: (_, value) =>
                                        value === '0000'
                                            ? Promise.resolve()
                                            : Promise.reject('Invalid security code!'),
                                },
                            ]}
                        >
                            <Input.Password placeholder="Enter Admin Security Code" size="large" />
                        </Form.Item>
                        )}
                        <Form.Item>
